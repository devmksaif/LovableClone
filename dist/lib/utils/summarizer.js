 ...
 */
export async function summarizeConversation(messages, maxMessages = 10) {
 ...
 */
export async function summarizeFileContents(files, maxFileSize = 500) {
 ...
 */
export function shouldCompress(text, maxTokens = 2000) {
